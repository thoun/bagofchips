...
This project is an adaptation for BoardGameArena of game BagOfChips edited by Bombyx.
...
```
If you use it for another game, replace `bagofchips` mentions on package.json `build:scss` script and on tsconfig.json `files` property.
