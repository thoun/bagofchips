...
class CenterSpot {
    ...
    public visibleToken: VisibleDeck<Destination>;

    private cardCounter: Counter;
    private tokenCounter: Counter;

    constructor(
        private game: BagOfChipsGame,
        ...
        this.visibleToken = new VisibleDeck<Destination>(game.tokensManager, document.getElementById(`center-spot-${pile}-token`), {
            width: 68,
            height: 68,
    ...
    public setNewToken(newToken: Destination, newCount: number) {
        if (newToken) {
